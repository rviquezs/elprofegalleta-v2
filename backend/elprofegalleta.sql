...
INSERT INTO `courses` (`id`, `name`, `duration`, `modalidad`, `category`, `price`, `promoter`, `inscriptions`, `qr_code`, `img1`, `img2`, `img3`, `last_updated`) VALUES
...
INSERT INTO `promoters` (`id`, `name`, `phone_number`, `whatsapp`, `email`) VALUES
...
INSERT INTO `testimonies` (`id`, `user_id`, `course_id`, `rating`, `comment`, `created_at`) VALUES
...
INSERT INTO `users` (`id`, `cedula`, `password`, `name`, `last_name1`, `last_name2`, `email`, `whatsapp`, `phone_number`, `picture`, `role`, `date_created`) VALUES
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`promoter`) REFERENCES `promoters` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `testimonies`
--
ALTER TABLE `testimonies`
  ADD CONSTRAINT `testimonies_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `testimonies_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

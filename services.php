...
<div class="services-container container md-4">
    <h1 class="text-center mb-4">Servicios</h1>
    <p class="description">Descubre nuestros servicios diseñados para mejorar tus habilidades y alcanzar tus objetivos en un entorno flexible y personalizado.</p>

    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card">
                <img src="img/grupal.jpg" class="card-img-top" alt="Clases Grupales">
                <div class="card-body">
                    <h2 class="card-title"><a href="#">Clases Grupales</a></h2>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <img src="img/grupales.png" class="card-img-top" alt="Grupos Conversacionales">
                <div class="card-body">
                    <h2 class="card-title"><a href="#">Grupos Conversacionales</a></h2>
